...
public class BallDrop {
     ...
     * 1.如果小球第一次就碎掉了，就剩下一个小球，那么为了确定临界点，只能从第一层开始，第y-1层结束，
     * 一层层往上扔，哪一层碎掉，临界点就是那一层,
     ...
     * 所以测试方法就是先用第一个小球在上面序列表示的层数上扔球，直到第一个小球碎掉，层数为n，
     * 然后再从序列中碎掉的层数n的前面一个层摔不破的层开始一层层往上加的扔第二个球，
     * 直到第二个球碎掉或者层数为n-1。最坏的情况也只需要14次
